...
//Creating the home content
const homeContent = new PostList({
  startingContent: homeStartingContent,
  posts: []
})

PostList.find({}, function (err, foundItems) {
...
app.get("/", function(req, res){
  ...
  res.render("home", {
    startingContent: homeStartingContent,
    posts: homeContent.posts
    });
    console.log(homeContent.posts);
});
